...
// whichever files were touched that phase (most recently Phase 159's
// revert, undoing the dark navy hero-band recolor) — clean every time it's
// been run. Not part of the app — nothing imports or runs it. The
// sandbox's shell can't delete this file (permissions error, same
