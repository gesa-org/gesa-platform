...
// were touched that phase (most recently Phase 161's treatment-type pill
// selector) — clean every time it's been run. Not part of the app —
// nothing imports or runs it. The sandbox's shell can't delete this file
