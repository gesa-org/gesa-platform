...
const DONATE_EDITABLE_FIELDS: EditableFieldDef[] = [
  ...
  // caption per photo (3-6 words, per Roy's spec).
  { contentId: "donate.impactGallery.eyebrow", path: "impactGalleryEyebrow", label: "Gallery eyebrow", type: "plainText", group: "Impact gallery", maxLength: 40, contentScope: "page" },
  { contentId: "donate.impactGallery.heading", path: "impactGalleryHeading", label: "Gallery heading", type: "heading", group: "Impact gallery", maxLength: 100, contentScope: "page" },
  { contentId: "donate.impactGallery.subtitle", path: "impactGallerySubtitle", label: "Gallery subtitle", type: "plainText", group: "Impact gallery", maxLength: 200, contentScope: "page" },
  { contentId: "donate.impactGallery.photo1Image", path: "galleryPhoto1Image", label: "Gallery photo 1", type: "image", group: "Impact gallery", contentScope: "page", pairedAltContentId: "donate.impactGallery.photo1ImageAlt" },
  { contentId: "donate.impactGallery.photo1ImageAlt", path: "galleryPhoto1ImageAlt", label: "Gallery photo 1 alt text", type: "altText", group: "Impact gallery", maxLength: 200, contentScope: "page" },
  { contentId: "donate.impactGallery.photo1Caption", path: "galleryPhoto1Caption", label: "Gallery photo 1 caption", type: "plainText", group: "Impact gallery", maxLength: 60, contentScope: "page" },
  { contentId: "donate.impactGallery.photo2Image", path: "galleryPhoto2Image", label: "Gallery photo 2", type: "image", group: "Impact gallery", contentScope: "page", pairedAltContentId: "donate.impactGallery.photo2ImageAlt" },
  { contentId: "donate.impactGallery.photo2ImageAlt", path: "galleryPhoto2ImageAlt", label: "Gallery photo 2 alt text", type: "altText", group: "Impact gallery", maxLength: 200, contentScope: "page" },
  { contentId: "donate.impactGallery.photo2Caption", path: "galleryPhoto2Caption", label: "Gallery photo 2 caption", type: "plainText", group: "Impact gallery", maxLength: 60, contentScope: "page" },
  { contentId: "donate.impactGallery.photo3Image", path: "galleryPhoto3Image", label: "Gallery photo 3", type: "image", group: "Impact gallery", contentScope: "page", pairedAltContentId: "donate.impactGallery.photo3ImageAlt" },
  { contentId: "donate.impactGallery.photo3ImageAlt", path: "galleryPhoto3ImageAlt", label: "Gallery photo 3 alt text", type: "altText", group: "Impact gallery", maxLength: 200, contentScope: "page" },
  { contentId: "donate.impactGallery.photo3Caption", path: "galleryPhoto3Caption", label: "Gallery photo 3 caption", type: "plainText", group: "Impact gallery", maxLength: 60, contentScope: "page" },
  { contentId: "donate.impactGallery.photo4Image", path: "galleryPhoto4Image", label: "Gallery photo 4", type: "image", group: "Impact gallery", contentScope: "page", pairedAltContentId: "donate.impactGallery.photo4ImageAlt" },
  { contentId: "donate.impactGallery.photo4ImageAlt", path: "galleryPhoto4ImageAlt", label: "Gallery photo 4 alt text", type: "altText", group: "Impact gallery", maxLength: 200, contentScope: "page" },
  { contentId: "donate.impactGallery.photo4Caption", path: "galleryPhoto4Caption", label: "Gallery photo 4 caption", type: "plainText", group: "Impact gallery", maxLength: 60, contentScope: "page" },
  { contentId: "donate.impactGallery.photo5Image", path: "galleryPhoto5Image", label: "Gallery photo 5", type: "image", group: "Impact gallery", contentScope: "page", pairedAltContentId: "donate.impactGallery.photo5ImageAlt" },
  { contentId: "donate.impactGallery.photo5ImageAlt", path: "galleryPhoto5ImageAlt", label: "Gallery photo 5 alt text", type: "altText", group: "Impact gallery", maxLength: 200, contentScope: "page" },
  { contentId: "donate.impactGallery.photo5Caption", path: "galleryPhoto5Caption", label: "Gallery photo 5 caption", type: "plainText", group: "Impact gallery", maxLength: 60, contentScope: "page" },
  { contentId: "donate.impactGallery.photo6Image", path: "galleryPhoto6Image", label: "Gallery photo 6", type: "image", group: "Impact gallery", contentScope: "page", pairedAltContentId: "donate.impactGallery.photo6ImageAlt" },
  { contentId: "donate.impactGallery.photo6ImageAlt", path: "galleryPhoto6ImageAlt", label: "Gallery photo 6 alt text", type: "altText", group: "Impact gallery", maxLength: 200, contentScope: "page" },
  { contentId: "donate.impactGallery.photo6Caption", path: "galleryPhoto6Caption", label: "Gallery photo 6 caption", type: "plainText", group: "Impact gallery", maxLength: 60, contentScope: "page" },
  { contentId: "donate.impactGallery.photo7Image", path: "galleryPhoto7Image", label: "Gallery photo 7", type: "image", group: "Impact gallery", contentScope: "page", pairedAltContentId: "donate.impactGallery.photo7ImageAlt" },
  { contentId: "donate.impactGallery.photo7ImageAlt", path: "galleryPhoto7ImageAlt", label: "Gallery photo 7 alt text", type: "altText", group: "Impact gallery", maxLength: 200, contentScope: "page" },
  { contentId: "donate.impactGallery.photo7Caption", path: "galleryPhoto7Caption", label: "Gallery photo 7 caption", type: "plainText", group: "Impact gallery", maxLength: 60, contentScope: "page" },
  // Phase 224 — founder/team message, directly after the donation form.
  { contentId: "donate.founder.heading", path: "founderHeading", label: "Founder section heading", type: "heading", group: "Founder message", maxLength: 100, contentScope: "page" },
  { contentId: "donate.founder.quote", path: "founderQuote", label: "Founder quote", type: "plainText", group: "Founder message", maxLength: 300, contentScope: "page" },
  { contentId: "donate.founder.body", path: "founderBody", label: "Founder body copy", type: "plainText", group: "Founder message", maxLength: 500, contentScope: "page" },
  { contentId: "donate.founder.signature", path: "founderSignature", label: "Signature line", type: "plainText", group: "Founder message", maxLength: 60, contentScope: "page" },
  { contentId: "donate.founder.image", path: "founderImage", label: "Founder/team photo", type: "image", group: "Founder message", contentScope: "page", pairedAltContentId: "donate.founder.imageAlt" },
  { contentId: "donate.founder.imageAlt", path: "founderImageAlt", label: "Founder/team photo alt text", type: "altText", group: "Founder message", maxLength: 200, contentScope: "page" },
  { contentId: "donate.founder.linkLabel", path: "founderLinkLabel", label: "\"Learn about GESA\" link label", type: "ctaLabel", group: "Founder message", maxLength: 40, contentScope: "page" },
  { contentId: "donate.founder.linkUrl", path: "founderLinkHref", label: "\"Learn about GESA\" link URL", type: "url", group: "Founder message", contentScope: "page" },
  { contentId: "donate.movement.heading", path: "movementHeading", label: "Final CTA heading", type: "heading", group: "Final CTA", maxLength: 140, contentScope: "page" },
  { contentId: "donate.movement.subtitle", path: "movementSubtitle", label: "Final CTA subtitle", type: "plainText", group: "Final CTA", maxLength: 240, contentScope: "page" },
  { contentId: "donate.movement.ctaLabel", path: "movementCtaLabel", label: "Final CTA button label", type: "ctaLabel", group: "Final CTA", maxLength: 40, contentScope: "page" },
  { contentId: "donate.movement.ctaUrl", path: "movementCtaHref", label: "Final CTA link (defaults to #giving-box, scrolling to the donation form)", type: "url", group: "Final CTA", contentScope: "page" },
