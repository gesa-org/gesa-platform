      ...
      <div className="flex flex-col gap-5">
        ...
        {ui.lastPublishedAt && (
          <p className="text-[12px] text-muted-fg">
            {/* Phase 185 — fixed locale/timeZone; see BookingRequestsTable.tsx's Phase 185 comment. */}
            Last published {new Date(ui.lastPublishedAt).toLocaleString("en-US", { timeZone: "UTC" })}. The live site&apos;s cache was flushed —
