        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: "Support Groups link label",
              help: "Phase 117: the Explore column now always mirrors the top navigation — edit the Header tab instead.",
              archived: true,
            },
        ...
        },
        {
          ...
          fields: [
            ...
            { key: "supportJoinGroupLabel", label: "Join a Group link label" },
            {
              ...
              help: "Phase 117: this used to be a second Donate link pointing to a different page than the header's own Donate button. Removed to avoid two mismatched Donate links in the same footer — Donate now appears once, in the Explore column, sharing the header's link.",
              archived: true,
            },
