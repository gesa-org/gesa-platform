...
//
// Phase 159 — briefly switched this icon color to `text-white` to stay
// visible against a dark navy hero-band background; reverted back to
// `text-foreground` alongside the rest of that phase once Roy said the new
// color didn't work on the live site.
